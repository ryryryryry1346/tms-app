                    ...
                    {sectionTests.length === 0 ? (
                      ...
                      sectionTests.map((test) => {
                        ...
                        return (
                          <article
                            key={test.id}
                            className="rounded-2xl border border-[var(--line)] bg-white/70 px-4 py-4 shadow-[0_12px_28px_rgba(23,58,64,0.06)]"
                          >
                            <div className="flex flex-wrap items-center justify-between gap-3">
                              <div className="min-w-0">
                                ...
                                <Link
                                  ...
                                  className="mt-1 block truncate text-base font-semibold no-underline text-[var(--sea-ink)] hover:text-[var(--lagoon-deep)]"
                                >
                                  #{test.id}. {test.title}
                                </Link>
                              </div>
                              ...
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                <button
                                  ...
                                  className="rounded-full border border-[var(--chip-line)] bg-[var(--chip-bg)] px-3 py-1 text-xs font-semibold text-[var(--sea-ink-soft)] disabled:cursor-not-allowed disabled:opacity-55"
                                >
                                  {isPending
                                    ? 'Saving...'
                                    : test.status === 'Passed'
